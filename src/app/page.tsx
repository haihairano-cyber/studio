...
import { UploadCloud, PlusCircle, Loader2, CheckCircle, XCircle, AlertCircle, BookCopy, FileImage, ClipboardCheck, Trash2, Edit, Plus, X, Camera, FilePlus } from 'lucide-react';
          ...
          <Sidebar>
            <SidebarHeader>
              <div className="flex justify-between items-center">
                 <h2 className="text-lg font-semibold">Gabaritos</h2>
                 <Button variant="ghost" size="icon" onClick={openNewForm}>
              ...
              <SidebarMenu>
                {templates.map((template) => (
                  <SidebarMenuItem key={template.id}>
                    ...
                    <div className="flex absolute right-1 top-1.5">
                      <SidebarMenuAction asChild>
                        <Button
                          variant="ghost"
                          size="icon"
                          className="h-7 w-7"
                          onClick={() => openEditForm(template.id)}
                        >
                    ...
                    <CardHeader>
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <CardDescription>
                            {selectedTemplate ? `Gabarito selecionado: ${selectedTemplate.name}` : 'Selecione um gabarito na barra lateral ou crie um novo.'}
                          </CardDescription>
                        </div>
                      </div>
                    </CardHeader>
